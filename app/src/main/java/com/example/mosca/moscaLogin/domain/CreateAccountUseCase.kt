...
class CreateAccountUseCase @Inject constructor(
    ...
    suspend fun invoke(userRegisterModel: UserRegisterModel): Boolean{
        val accountCreated =
            authenticationService.createAccount(userRegisterModel.email, userRegisterModel.password) != null
